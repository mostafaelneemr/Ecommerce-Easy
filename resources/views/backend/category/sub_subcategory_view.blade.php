                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($subsubcategory as $item)
                                        <tr>
                                            ...
                                            <td width="25%">
                                                <a href="{{ route('sub.subcategory.edit', $item->id) }}" class="btn btn-info" title="edit"><i class="fa fa-pencil"></i></a>
                                                <a href="{{ route('sub.subcategory.delete', $item->id) }}" class="btn btn-danger" id="delete" title="delete"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
