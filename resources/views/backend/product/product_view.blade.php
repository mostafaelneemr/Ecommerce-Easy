...
{{--                                            <td>{{ $item->discount_price }}</td>--}}
                                            ...
                                            <td width="25%">
                                                <a href="{{ route('edit.product', $item->id) }}" class="btn btn-primary" title="Details Product"><i class="fa fa-eye"></i></a>
                                                ...
                                                @if($item->status == 1)
                                                    <a href="{{ route('inactive.product', $item->id) }}" class="btn btn-danger" title="InActive Now"><i class="fa fa-arrow-down"></i></a>
                                                @else
                                                    <a href="{{ route('active.product', $item->id) }}" class="btn btn-success" title="Active Now"><i class="fa fa-arrow-up"></i></a>
                                                @endif
                                            </td>
                                        </tr>
                                    @endforeach
