                                    ...
                                    <ul class="dropdown-menu mega-menu">
                                        <li class="yamm-content">
                                            <div class="row">
                                                ...
                                                @php    
                                                $subcategories = App\Models\Backend\SubCategory::where('category_id', $category->id)->orderBy('subcategory_name_en', 'ASC')->get();
                                                @endphp
                                                ...
                                                <div class="col-sm-12 col-md-3">
                                                    ...
                                                    @php    
                                                    $subsubcategories = App\Models\Backend\SubSubCategory::where('subcategory_id', $subcategory->id)->orderBy('subsubcategory_name_en', 'ASC')->get();
                                                    @endphp
                            ...
                            <div class="tab-pane" id="category{{$category->id}}">
                                <div class="product-slider">
                                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                                        ...
                                        @php
                                            $catwiseProduct = App\Models\Backend\Product::where('category_id', $category->id)->orderBy('id', 'DESC')->get();
                                        @endphp
